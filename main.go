...
<body>
    <script type="text/javascript">
        var sock = null;
        var wsuri = "ws://127.0.0.1:8080/reload";
...
func ReadAndRender(fileName string) ([]byte, error) {
	...
	s := html_top + string(md) + html_bottom
	return []byte(s), nil
}
